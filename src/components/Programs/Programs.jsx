...
>
    {['college1', 'college2', 'college3'].map((college, index) => (
        <Tab
            key={college}
            label={college === 'college1' ? 'Amrit Law College' : college === 'college2' ? 'Roorkee Degree College' : 'Amrit College of Education'}
            value={college}
            sx={{
                color: 'white',
                fontWeight: 'bold',
                ...
                margin: '0 56px', // Increase space between each tab
